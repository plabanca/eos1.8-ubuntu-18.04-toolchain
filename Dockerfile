...
RUN wget --quiet https://boostorg.jfrog.io/artifactory/main/release/1.70.0/source/boost_1_70_0.tar.bz2 \
...
RUN git clone --recursive https://github.com/plabanca/eos --branch release/1.8.x --single-branch \
    && cd eos \
...
# Install eosio.cdt
RUN wget --quiet https://github.com/EOSIO/eosio.cdt/releases/download/v1.6.3/eosio.cdt_1.6.3-1-ubuntu-18.04_amd64.deb \
